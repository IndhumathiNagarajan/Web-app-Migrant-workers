...
<%
    ...
    if(request.getParameter("aj")!=null) {
        ps1 = conn.prepareStatement("update newjob set astatus='accept' where id=?");
    ...
    out.print("<table class='report_tab'><thead><tr><th colspan='7'>REGISTERED JOBS</th><tr><th>Company Id<th>Owner Name<th>Company name<th>Job Name<th>Category<th>Salary<th>Task</tr></thead><tbody>");
        while(rs1.next()) {
            ...
            out.print("<td><a href='viewjobs.jsp?aj="+rs1.getString(1)+"' onclick=\"javascript:return confirm('Are You Sure to Accept ?')\">Accept</a> | <a href='viewjobs.jsp?dj="+rs1.getString(1)+"' onclick=\"javascript:return confirm('Are You Sure to Delete ?')\">Delete</a>");
        }
    ps1.close();
