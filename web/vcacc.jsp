...
<%
    ...
    out.print("<table class='report_tab'><thead><tr><th colspan='7'>ACCEPTED JOBS</th><tr><th>Job Name<th>Category<th>Salary<th>Emp Id<th>Task</tr></thead><tbody>");
        while(rs1.next()) {
            out.print("<tr>");
            ...
            out.print("<td><a href='vemp.jsp?uid="+rs1.getString(6)+"'>View</a>");
        }
    ps1.close();
