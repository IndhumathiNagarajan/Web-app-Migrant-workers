...
<%
    ...
    if(request.getParameter("auser")!=null) {
        ps1 = conn.prepareStatement("update newcompany set astatus='accept' where userid=?");
        ps1.setString(1, request.getParameter("auser"));
        ps1.executeUpdate();
    }
    ps1 = conn.prepareStatement("select * from newcompany where astatus='pending'");
    rs1 = ps1.executeQuery();
    out.print("<table class='report_tab'><thead><tr><th colspan='10'>REGISTERED COMPANIES</th><tr><th>Name<th>Company<th>Address<th>City<th>GSTIN<th>Mobile<th>User Id<th>Photo<th>ID Proof<th>Task</tr></thead><tbody>");
        while(rs1.next()) {
            out.print("<tr>");
            ...
            out.print("<td><a href='viewcomp.jsp?auser="+rs1.getString(7)+"' onclick=\"javascript:return confirm('Are You Sure to Accept ?')\">Accept</a> | <a href='viewcomp.jsp?duser="+rs1.getString(7)+"' onclick=\"javascript:return confirm('Are You Sure to Delete ?')\">Delete</a>");
        }
    ps1.close();
