...
<%
    ...
    out.print("<table class='report_tab'><thead><tr><th colspan='10'>ACCEPTED WORKERS</th><tr><th>Name<th>Gender<th>Address<th>State<th>Country<th>Mobile<th>User Id<th>Photo<th>ID Proof<th>Task</tr></thead><tbody>");
        while(rs1.next()) {
            out.print("<tr>");
            ...
            out.print("<td><a href='accworkers.jsp?duser="+rs1.getString(7)+"' onclick=\"javascript:return confirm('Are You Sure to Delete ?')\">Delete</a>");
        }
    ps1.close();
